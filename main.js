...
// let rightHandValue = document.querySelectorAll("input[name='right-hand']");

// let findSelectedRightHand = () => {
//     let rightHandSelected = document.querySelector("input[name='right-hand']:checked");
//     let rightHandFigure = document.querySelector('.right-hand');
//     console.log(rightHandSelected.value);
//     if (rightHandSelected.value = "true") {
//         console.log("не член");
//     }
    // if (rightHandSelected.value = "true") {
    //     console.log('член');
    //     rightHandFigure.classList.add("body-active");
    // } else if (rightHandSelected.value = "false") {
    //     console.log('не член');
    //     rightHandFigure.classList.remove("body-active");
    // }
// }

// rightHandValue.forEach(rightHand => {
//     rightHand.addEventListener("change", findSelectedRightHand);
// });
...
//     genderResult.textContent = 'Женщина';
// } else if (male.checked == true) {
//     genderResult.textContent = 'Мужчина';
// }

      
// const genderButton = document.querySelectorAll('input[name="gender"]');
